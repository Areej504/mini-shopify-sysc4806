...
- Milestone 2 (in progress): Deliver a 10–15 minute demo showcasing the complete, feature-complete product with an intuitive interface, and update the README with the final scope, features, limitations, and user instructions.
